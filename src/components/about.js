...
const About = () => {
  const data = useStaticQuery(graphql`
    query aboutQuery {
      file(relativePath: { eq: "images/about_illus.png" }) {
        childImageSharp {
    ...
    <main>
      <style jsx>{`
        ...
        .card {
          ...
          max-width: 250px;
          -webkit-box-shadow: 14px 10px 0px -2px rgba(211, 47, 47, 1);
          -moz-box-shadow: 14px 10px 0px -2px rgba(211, 47, 47, 1);
          box-shadow: 14px 10px 0px -2px rgba(211, 47, 47, 1);
        }
        .card-content {
          font-family: Gilmer-light;
          font-size: 15px;
            ...
            <div className="about-content-holder">
              <div className="content">
                ...
                <div className="About-content">
                  ...
                  goal is to bring young and skilled developers from in and
                  around Karnataka under the same roof.
                  <br />
                  <br /> This event aims to create a platform to collaborate
                  with various clubs and organizations, discuss the newest
                  technologies and trends in the IT industry and also train
